...
public class UserService {
    ...
    public UserRecord create(long actorUserId, UserRequest request) {
        ...
        UserRecord user = store.createUser(request.username(), request.displayName(), request.reportToUserId(), request.wecomUserId(), request.departmentName());
    ...
    public UserRecord updatePermissionOverrides(long actorUserId, long userId, Map<String, PermissionEffect> overrides) {
        ...
        auditService.record(actorUserId, "iam.user.permission_overrides.update", "iam_user", String.valueOf(user.id()));
        return user;
    }
    ...
    public record UserRequest(String username, String displayName, Long reportToUserId, String wecomUserId, String departmentName) {
    }
}
